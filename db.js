const items = [
  ...
  },
  {
    ...
    rarity: "Legendary",
    type: "Staff",
    damageRange: [20.0, 150.5],
    element: "Shadow",
    slots: ["Main Hand"],
    attributes: { Vitality: "{7,50}" },
    effects: ["Shadow Damage {8,40}%"],
    bosses: ["The Broker"],
  ...
  },
  {
    ...
    rarity: "Legendary",
    type: "Sword_1H",
    damageRange: [12.5, 88.5],
    element: "Physical",
    slots: ["Main Hand"],
    attributes: {},
    effects: ["10% chance to cast Level [level value] {SKL=Curse} when striking."],
    bosses: ["Ancient Guardian", "Ancient Slaver"],
  ...
  },
  {
    ...
    rarity: "Legendary",
    type: "Sword_1H",
    damageRange: [11.5, 80.0],
    element: "Physical",
    slots: ["Main Hand"],
    attributes: { Dexterity: "{4,30}" },
    effects: [],
    bosses: ["Blood Mask Boss", "Assassin"],
    zones: [
  ...
  },
  {
    ...
    rarity: "Legendary",
    type: "FistWeapon",
    damageRange: [8.5, 54.5],
    element: "Physical",
    slots: ["Main Hand"],
    attributes: {},
    effects: ["Basic attacks have a 20% chance to proc an additional attack once per turn."],
    bosses: ["Global Loot"],
    zones: []
  },
  {
    ...
    rarity: "Legendary",
    type: "Axe_2H",
    damageRange: [25.5, 192.5],
    element: "Physical",
    slots: ["Main Hand"],
    attributes: { Might: "{2,10}", Vitality: "{2,10}" },
    effects: ["Weapon attacks apply 2 stacks of bleeding."],
    bosses: ["The Bishop", "The Butcher", "The Jester"],
    zones: [
      "CastleGloom Day",
  ...
  },
  {
    ...
    rarity: "Legendary",
    type: "Mace_2H",
    damageRange: [24.5, 184.5],
    element: "Shadow",
    slots: ["Main Hand"],
    attributes: { Might: "{2,10}", Vitality: "{2,10}" },
    effects: ["% Life Steal 6"],
    bosses: ["The Baron"],
  ...
  },
  {
    ...
    rarity: "Legendary",
    type: "Axe_1H",
    damageRange: [13.5, 96.5],
    element: "Shadow",
    slots: ["Main Hand"],
    attributes: {},
    effects: ["% Life Steal 3"],
    bosses: ["Samara the Vampire", "The Baron", "The Duke"],
    zones: ["CastleGloom Day", "CastleGloom Night"]
  },
  {
    name: "Crimson Sceptre",
    rarity: "Legendary",
    type: "Staff",
    damageRange: [16.5, 120.0],
    element: "Shadow",
    slots: ["Main Hand"],
    attributes: { Might: "{8,60}" },
    effects: ["% Mana Steal 5%"],
    bosses: ["The Countess"],
    zones: ["CastleGloom Day", "CastleGloom Night"]
  },
  {
    ...
    rarity: "Legendary",
    type: "Sword_2H",
    damageRange: [26.5, 200.0],
    element: "Physical",
    slots: ["Main Hand"],
    attributes: {},
    effects: ["% Life Steal 6", "Weapon attacks apply 2 stacks of bleeding."],
    bosses: ["Samara the Vampire", "The Duke"],
    zones: ["CastleGloom Day", "CastleGloom Night"]
  },
  {
    ...
    rarity: "Legendary",
    type: "Sword_2H",
    damageRange: [21.5, 160.0],
    element: "Physical",
    slots: ["Main Hand"],
    attributes: { Might: "{2,15}", Dexterity: "{2,15}", Vitality: "{2,15}" },
    effects: [],
    bosses: ["Global Loot"],
    zones: []
  },
  {
    ...
    rarity: "Legendary",
    type: "Staff",
    damageRange: [21.5, 156.5],
    element: "Lightning",
    slots: ["Main Hand"],
    attributes: { Intelligence: "{7,50}" },
    effects: ["Increased power for mana use {7,35}%"],
    bosses: ["Global Loot"],
    zones: []
  },
  {
    ...
    slots: ["Main Hand"],
    attributes: {},
    effects: ["Striking with this weapon applies 1 stack of {STA=Bleeding}."],
    bosses: ["Councilor Jahsun", "Avatar of Xotec", "Medusa"],
    zones: [
      "EmeraldJungle Night",
      "WaterTempleRuins Day",
      "EmeraldJungle Day",
  ...
  },
  {
    ...
    element: "Physical",
    slots: ["Main Hand"],
    attributes: { Might: "{3,20}", Vitality: "{3,20}" },
    effects: ["10% chance to cast Level [level value] {SKL=Slam} on striking."],
    bosses: ["Mountain King Ironheart"],
  ...
  },
  {
    ...
    element: "Physical",
    slots: ["Main Hand"],
    attributes: { Might: "{3,20}", Reflex: "{3,20}" },
    effects: ["Max Health 20%"],
    bosses: ["Global Loot"],
    zones: []
  },
  {
    name: "Gentleman's Pistol",
    rarity: "Legendary",
    type: "Gun_1H",
    damageRange: [11.5, 77.5],
    element: "Physical",
    slots: ["Main Hand"],
    attributes: { Reflex: "{3,20}" },
    effects: ["Dodge Counter Damage {6,30}%"],
  ...
  },
  {
    ...
    rarity: "Legendary",
    type: "Axe_2H",
    damageRange: [23.5, 176.5],
    element: "Physical",
    slots: ["Main Hand"],
    attributes: { Might: "{3,20}", Vitality: "{3,20}" },
    effects: [],
    bosses: ["Olgoi, Devourer of Treasure", "Captain of the Ruby Rum"],
    zones: [
      "DwarvenHalls Day",
      "WaterTempleRuins Day",
      "DwarvenHalls Night",
  ...
  },
  {
    ...
    slots: ["Main Hand"],
    attributes: { Reflex: "{3,20}" },
    effects: ["Dodge Counter Damage {8,40}%"],
    bosses: ["Olgoi, Devourer of Treasure", "Captain of the Emerald Eel"],
    zones: [
      "DwarvenHalls Day",
      "WaterTempleRuins Day",
      "DwarvenHalls Night",
  ...
  },
  {
    ...
    rarity: "Legendary",
    type: "Wand",
    damageRange: [10.5, 72.5],
    element: "Healing",
    slots: ["Main Hand"],
    attributes: { Might: "{2,15}", Intelligence: "{2,15}" },
    effects: ["Holy Power {2,10}%"],
    bosses: ["Herald of the Abyss", "Emperor Marcus"],
  ...
  },
  {
    ...
    element: "Physical",
    slots: ["Main Hand"],
    attributes: { Might: "{3,20}", Dexterity: "{4,30}" },
    effects: [],
    bosses: ["Global Loot"],
    zones: []
  },
  {
    ...
    element: "Fire",
    slots: ["Main Hand"],
    attributes: { Might: "{8,60}", Vitality: "{2,15}", Intelligence: "{2,15}" },
    effects: [],
    bosses: ["Olgoi, Devourer of Treasure"],
    zones: ["DwarvenHalls Day", "DwarvenHalls Night"]
  },
  {
    ...
    rarity: "Legendary",
    type: "Sword_1H",
    damageRange: [13.5, 100.0],
    element: "Physical",
    slots: ["Main Hand"],
    attributes: { Dexterity: "{3,20}" },
    effects: [],
    bosses: ["Lucilla", "Proximo"],
    zones: []
  },
  {
    name: "Goblin Shaman Staff",
    rarity: "Legendary",
    type: "Staff",
    damageRange: [19.5, 144.5],
    element: "Fire",
    slots: ["Main Hand"],
    attributes: { Might: "{6,45}", Intelligence: "{2,15}" },
    effects: ["Fire Damage {6,30}%", "Holy Power {6,30}%"],
    bosses: ["Goblin Shaman", "The Gobfather", "Iceclaw Witch Doctor", "Pale Witch Doctor", "The Pale Goblin"],
    zones: [
      "WyrmrestDesert Day",
  ...
  },
  {
    ...
    element: "Physical",
    slots: ["Main Hand"],
    attributes: { Dexterity: "{2,15}" },
    effects: ["Additional Weapon Damage Source[\"Dexterity\"] * .075f\nGain Additional Weapon Damage equal to 7.5% of your Dexterity."],
    bosses: ["Unchained Efreet"],
    zones: ["WyrmrestDesert Day", "WyrmrestDesert Night"]
  },
  {
    ...
    rarity: "Legendary",
    type: "Wand",
    damageRange: [12.5, 90.5],
    element: "Healing",
    slots: ["Main Hand"],
    attributes: {},
    effects: ["Holy Power {5,25}%"],
    bosses: ["The Bishop"],
    zones: ["CastleGloom Day", "SunkenSwamplands Day", "CastleGloom Night", "SunkenSwamplands Night"]
  },
  {
    ...
    rarity: "Legendary",
    type: "Wand",
    damageRange: [8.5, 60.0],
    element: "Fire",
    slots: ["Main Hand"],
    attributes: { Might: "{4,30}", Intelligence: "{2,15}" },
    effects: [],
    bosses: ["Global Loot"],
    zones: []
  },
  {
    ...
    rarity: "Legendary",
    type: "Bow",
    damageRange: [15.5, 112.5],
    element: "Physical",
    slots: ["Main Hand"],
    attributes: { Dexterity: "{4,30}" },
    effects: ["Additional Weapon Damage Source[\"Dexterity\"] * .30f\nGain Additional Weapon Damage equal to 30% of your Dexterity."],
    bosses: ["Global Loot"],
    zones: []
  },
  {
    ...
    attributes: {},
    effects: [],
    bosses: ["Admiral Blackbeard", "The Prospector"],
    zones: ["ForgottenMines Night", "ForgottenMines Day", "WaterTempleRuins Day", "WaterTempleRuins Night"]
  },
  {
    name: "Holy Blade",
    rarity: "Legendary",
  ...
  },
  {
    ...
    slots: ["Main Hand"],
    attributes: {},
    effects: ["Attacks with this weapon apply 1 stack of bleeding."],
    bosses: ["Global Loot"],
    zones: []
  },
  {
  ...
  },
  {
    ...
    element: "Physical",
    slots: ["Main Hand"],
    attributes: { Might: "{4,30}", Vitality: "{3,20}" },
    effects: [],
  ...
  },
  {
    ...
    element: "Physical",
    slots: ["Main Hand"],
    attributes: { Vitality: "{3,20}", Intelligence: "{3,20}" },
    effects: ["Max Mana 20%"],
    bosses: ["Global Loot"],
    zones: []
  },
  {
    ...
    rarity: "Legendary",
    type: "FistWeapon",
    damageRange: [7.5, 48.5],
    element: "Shadow",
    slots: ["Main Hand"],
    attributes: {},
    effects: ["Striking with this weapon applies 1 stack of Poison."],
    bosses: ["Global Loot"],
    zones: []
  },
  {
  ...
  },
  {
    ...
    element: "Fire",
    slots: ["Main Hand"],
    attributes: { Might: "{3,20}", Intelligence: "{3,20}" },
    effects: ["Fire Damage {6,30}%"],
    bosses: ["Global Loot"],
    zones: []
  },
  ...
  },
  {
    ...
    slots: ["Main Hand"],
    attributes: {},
    effects: ["Fire Damage {4,20}%", "10% chance to apply Level [level value] {SKL=Immolate} on hit."],
    bosses: ["The Broker"],
    zones: ["Emberlands Day", "Emberlands Night"]
  },
  {
    ...
    element: "Fire",
    slots: ["Main Hand"],
    attributes: { Might: "{2,10}", Intelligence: "{1,5}" },
    effects: ["Fire Damage Source[\"Might\"] * .1f\nGain Added Damage to Fire equal to 10% of your Might."],
    bosses: ["Lord Infernicus", "The Forgemaster", "Nagomahu"],
    zones: [
      "Emberlands Day",
      "WyrmrestDesert Day",
  ...
  },
  {
    ...
    element: "Physical",
    slots: ["Main Hand"],
    attributes: { Reflex: "{2,15}" },
    effects: ["Additional Weapon Damage Source[\"Reflex\"] * .075f\nGain Additional Weapon Damage equal to 7.5% of your Reflex."],
    bosses: ["The Grandmaster"],
    zones: ["FrostwroughtMountain Night", "FrostwroughtMountain Day"]
  },
  {
    ...
    element: "Physical",
    slots: ["Main Hand"],
    attributes: { Might: "{3,20}", Dexterity: "{3,20}" },
    effects: ["Damage and Healing {3,15}%"],
    bosses: ["Unchained Efreet", "The Sultan"],
    zones: ["WyrmrestDesert Day", "WyrmrestDesert Night"]
  },
  {
    name: "Sapphire Cestus",
    rarity: "Legendary",
    type: "FistWeapon",
    damageRange: [8.5, 60.0],
    element: "Cold",
    slots: ["Main Hand"],
    attributes: { Might: "{2,10}", Intelligence: "{1,5}" },
    effects: ["Cold Damage Source[\"Might\"] * .1f\nGain Added Damage to Cold equal to 10% of your Might."],
    bosses: ["Global Loot"],
    zones: []
  },
  {
    name: "Sapphire Claymore",
    rarity: "Legendary",
    type: "Sword_2H",
    damageRange: [21.5, 160.0],
    element: "Cold",
    slots: ["Main Hand"],
    attributes: { Might: "{3,20}", Dexterity: "{2,10}", Vitality: "{3,20}" },
    effects: [],
    bosses: ["Global Loot"],
    zones: []
  },
  {
    name: "Sapphire Poleaxe",
    rarity: "Legendary",
    type: "Polearm",
    damageRange: [25.5, 192.5],
    element: "Cold",
  ...
  },
  {
    ...
    element: "Cold",
    slots: ["Main Hand"],
    attributes: { Might: "{2,10}", Intelligence: "{2,10}", Reflex: "{3,20}" },
    effects: ["Cold Damage {6,30}%"],
    bosses: ["Global Loot"],
    zones: []
  },
  {
    ...
    slots: ["Main Hand"],
    attributes: {},
    effects: ["Cold Damage {4,20}%", "10% chance to cast Level [level value] {SKL=Frost Shard} on hit."],
    bosses: ["Global Loot"],
    zones: []
  },
  {
    ...
    rarity: "Legendary",
    type: "Gun_2H",
    damageRange: [19.5, 140.0],
    element: "Physical",
    slots: ["Main Hand"],
    attributes: { Dexterity: "{7,50}" },
    effects: [],
    bosses: ["Lady of the Well", "The Scarecrow", "Captain of the Sapphire Sea"],
    zones: [
      "WaterTempleRuins Night",
      "CastleGloom Night",
      "WaterTempleRuins Day",
  ...
  },
  {
    ...
    slots: ["Main Hand"],
    attributes: { Might: "{3,20}" },
    effects: ["Summon Damage {4,20}%", "Summon Limit 1", "Summon Level Bonus 2"],
    bosses: ["The Sun Queen"],
    zones: ["WyrmrestDesert Day", "WyrmrestDesert Night"]
  },
  {
  ...
  },
  {
    ...
    element: "Physical",
    slots: ["Main Hand"],
    attributes: { Vitality: "{2,15}" },
    effects: ["Return Damage Physical Source[\"MaxHealth\"] * .01f\nGain Added Return Damage Physical equal to 1% of your Max Health."],
  ...
  },
  {
    ...
    element: "Physical",
    slots: ["Main Hand"],
    attributes: { Reflex: "{6,40}" },
    effects: ["Dodge Counter Damage {16,80}%"],
    bosses: ["The Black Knight"],
    zones: ["WyrmrestDesert Day", "WyrmrestDesert Night", "SunkenSwamplands Day", "SunkenSwamplands Night"]
  },
  {
    name: "Topaz Cestus",
    rarity: "Legendary",
    ...
    slots: ["Main Hand"],
    attributes: {},
    effects: ["Lightning Damage Source[\"Might\"] * .1f\nGain Added Damage to Lightning equal to 10% of your Might."],
    bosses: ["Tlaloc the Storm"],
  ...
  {
    name: "Topaz Greatsword",
    rarity: "Legendary",
    type: "Sword_2H",
    damageRange: [21.5, 160.0],
    element: "Lightning",
    slots: ["Main Hand"],
    attributes: { Dexterity: "{4,30}", Vitality: "{3,20}" },
    effects: [],
    bosses: ["Global Loot"],
    zones: []
  },
  ...
  },
  {
    ...
    slots: ["Main Hand"],
    attributes: {},
    effects: ["Lightning Damage {4,20}%", "8% chance on striking to cast Level [level value] {SKL=Shock}."],
    bosses: ["Global Loot"],
    zones: []
  },
  {
    name: "Topaz Sword-Staff",
    rarity: "Legendary",
    type: "Polearm",
    damageRange: [17.5, 128.5],
    element: "Lightning",
    slots: ["Main Hand"],
    attributes: { Dexterity: "{3,20}", Intelligence: "{3,20}" },
    effects: ["Lightning Damage {6,30}%"],
    bosses: ["Global Loot"],
    zones: []
  },
  {
    ...
    rarity: "Legendary",
    type: "Sword_1H",
    damageRange: [9.5, 64.5],
    element: "Shadow",
    slots: ["Main Hand"],
    attributes: {},
    effects: ["Shadow Damage {2,10}%", "Striking with this weapon applies 2 stack of Poison."],
    bosses: ["The Jester", "Twisted Soul of the Swamp"],
    zones: ["CastleGloom Day", "SunkenSwamplands Day", "CastleGloom Night", "SunkenSwamplands Night"]
  },
  {
    name: "Vanquisher Blade",
    rarity: "Legendary",
    type: "Sword_1H",
    damageRange: [11.5, 80.0],
    element: "Physical",
    slots: ["Main Hand"],
    attributes: { Might: "{4,30}" },
    effects: [],
    bosses: ["Global Loot"],
    zones: []
  },
  {
    name: "Vanquisher Sword",
    rarity: "Legendary",
    type: "Sword_2H",
    damageRange: [21.5, 160.0],
    element: "Physical",
    slots: ["Main Hand"],
    attributes: { Might: "{6,45}" },
    effects: [],
    bosses: ["Lady of the Well", "The Scarecrow", "Avatar of Xotec", "Medusa"],
    zones: [
      "WaterTempleRuins Night",
      "CastleGloom Night",
      "WaterTempleRuins Day",
  ...
  },
  {
    ...
    rarity: "Legendary",
    type: "FistWeapon",
    damageRange: [6.5, 45.5],
    element: "Physical",
    slots: ["Main Hand"],
    attributes: { Might: "{2,10}" },
    effects: ["10% chance to cast Quaking Fist on striking."],
    bosses: ["Azug Spikefist"],
    zones: []
  },
  //
